...
export default function Academy() {
  ...
  return (
    <div className="min-h-screen bg-[#0B1F3B] text-white font-sans selection:bg-[#d4af37] selection:text-[#0B1F3B]">
      ...
      >
        <nav className="container mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
            ...
            <a href="/files" className="hover:text-[#d4af37] transition-colors">
              File Manager
            </a>
          </div>
          {/* Desktop CTA */}
          <a
            ...
            className="hidden md:inline-flex bg-[#d4af37] hover:bg-[#b5952f] text-[#0B1F3B] px-6 py-2.5 rounded-md font-bold text-sm transition-colors"
          >
            Get The Book
          </a>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Understand the Bible as one connected story through a simple,
            chronological framework — from Creation to Restoration.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="https://continuum.chronologicalbibleacademy.com"
              className="w-full sm:w-auto bg-[#d4af37] hover:bg-[#b5952f] text-[#0B1F3B] px-8 py-4 rounded-md font-bold text-lg transition-all flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(212,175,55,0.3)]"
            >
            ...
            <a
              href="#courses"
              className="w-full sm:w-auto bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-md font-bold text-lg transition-all flex items-center justify-center gap-2 backdrop-blur-sm border border-white/10"
            >
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-serif font-bold mb-6 text-white">
              The 7-Step Continuum
            </h2>
            <p className="text-xl text-gray-400">
              The entire Bible follows one storyline. These seven movements show
              you how it all fits together — from the first page to the last.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="p-8 rounded-xl border bg-white/5 border-white/10 relative overflow-hidden group hover:bg-white/10 transition-colors"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:w-3/4 mx-auto">
              {[
                ...
                <div
                  key={i}
                  className={`p-8 rounded-xl border ${item.highlight ? "bg-[#d4af37]/10 border-[#d4af37] shadow-[0_0_20px_rgba(212,175,55,0.15)]" : "bg-white/5 border-white/10"} relative overflow-hidden group hover:bg-white/10 transition-colors`}
                >
                  <div
                    className={`text-6xl font-serif font-bold opacity-10 absolute right-4 top-4 ${item.highlight ? "text-[#d4af37]" : "text-white"}`}
                  >
                    {item.step}
                  </div>
                  <h4
                    className={`text-xl font-bold mb-3 relative z-10 ${item.highlight ? "text-[#d4af37]" : "text-white"}`}
                  >
                    {item.title}
                  </h4>
                  <p className="text-gray-400 text-sm leading-relaxed relative z-10">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white">
              Lives Changed by the Framework
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "I've been a Christian for 20 years and never truly understood how the Old Testament connected to Jesus. The 7-Step Continuum changed everything for me. I finally see the whole story.",
                name: "Sarah M.",
              ...
              {
                quote:
                  "This is the resource I wish I had when I first started reading the Bible. Bruce has a gift for making complex theology feel simple and accessible. I've already recommended it to my entire small group.",
                name: "James T.",
              ...
              {
                quote:
                  "I was skeptical at first — I've tried Bible reading plans before and always gave up. But the chronological framework gave me a roadmap. For the first time, I actually finished reading through the whole Bible.",
                name: "Rachel K.",
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Whether you want to read at your own pace or join a guided
              community, we have the resources to help you grow.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="h-48 bg-[#0B1F3B] relative flex items-center justify-center p-6">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-2xl font-serif font-bold text-white">
                    The Kingdom Continuum Series
                  </h3>
                </div>
              </div>
              <div className="p-8 flex-1 flex flex-col">
                <div className="inline-block bg-green-100 text-green-800 text-xs font-bold px-3 py-1 rounded-full mb-4 self-start">
                  Book One Available Now
                </div>
                <p className="text-gray-600 mb-6 flex-1">
                  Your launchpad into deeper study. "The Bible Finally Makes
                  Sense" walks you through the entire Bible using the 7-Step
                  Continuum. It's the perfect starting point for new believers.
                </p>
                <a
                  href="https://continuum.chronologicalbibleacademy.com"
                  className="inline-flex items-center gap-2 text-[#0B1F3B] font-bold hover:text-[#d4af37] transition-colors group"
                >
                  Get the Book{" "}
            ...
            >
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="inline-block bg-[#d4af37]/20 text-[#0B1F3B] text-xs font-bold px-3 py-1 rounded-full mb-4 self-start">
                  In Development
                </div>
                <p className="text-gray-600 mb-6 flex-1">
                  Walk through every era of Scripture with expert teaching,
                  guided reflection, and a community of like-minded believers.
                ...
                {waitlistDone ? (
                  <div className="mt-auto flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg px-4 py-3">
                    ...
                    <p className="text-green-800 font-semibold text-sm">
                      You're on the list! We'll notify you when courses launch.
                    </p>
                  </div>
                ) : (
                  <form
          ...
          <div className="max-w-4xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12 backdrop-blur-sm shadow-2xl">
            <div className="flex flex-col md:flex-row gap-10 items-center">
                  ...
                  <div className="flex-1 p-4 flex flex-col gap-2 bg-gray-50">
                    {[1, 2, 3, 4, 5, 6, 7].map(num => (
                      <div key={num} className="flex items-center gap-2">
                        <div className="w-4 h-4 rounded-full bg-[#d4af37] text-[#0B1F3B] text-[8px] font-bold flex items-center justify-center">
                          {num}
                        </div>
              ...
              <div className="w-full md:w-2/3 space-y-6 text-center md:text-left">
                <div className="inline-block bg-[#d4af37]/20 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">
                  Free Download
                </div>
                <h2 className="text-3xl md:text-4xl font-serif font-bold">
                  Get The Bible's Big Picture Guide
                </h2>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Stop playing "Bible Roulette." Download this beautiful,
                  print-ready guide to keep in your Bible. It shows you exactly
                  how the entire story connects from Creation to Restoration
                  across 7 Major Stages and 16 Key Movements.
                </p>
                {leadDone ? (
                  <div className="flex items-center gap-3 bg-[#d4af37]/10 border border-[#d4af37]/40 rounded-lg px-5 py-4 mt-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Check your inbox — your free guide is headed to you now.
                      </p>
                    </div>
                  </div>
                ) : (
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#d4af37] font-bold tracking-wide uppercase text-sm mb-6">
                Author &amp; Founder
              </p>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                With a Master of Theology and years of teaching experience,
                Bruce created the Chronological Bible Academy to help new
                believers and seeking Christians understand the Bible as one
                connected story.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed italic border-l-4 border-[#d4af37] pl-4">
                "My goal isn't to give you a seminary degree. My goal is to give
                you the roadmap so that when you open the Bible, you actually
      ...
      <section
        id="faq"
        className="py-24 bg-[#071529] text-white border-t border-white/10"
      >
          ...
          <div className="space-y-3">
            {[
              ...
              >
                ...
                >
                  <span className="font-semibold text-white group-hover:text-[#d4af37] transition-colors pr-4">
                    {item.q}
                  </span>
                  <ChevronDown
                ...
                >
                  <p className="px-6 py-5 text-gray-400 leading-relaxed border-t border-white/10">
                    {item.a}
                  </p>
                </div>
              </div>
